...
/**
 * REST controller for managing {@link com.vdev.todos.domain.Todo}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TodoResource {
     ...
     */
    @GetMapping("/todos")
    public ResponseEntity<List<Todo>> getAllTodos(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
